    ...
    $('.browser-table').each(function() {
        ...
        bonzo(this.querySelectorAll('.format-number')).each(function() {
            var value = this.getAttribute('data-value'),
                ...
                output = numberWithCommas(value) + ' <span class="perc">' + perc + '%</span>';
        ...
        bean.on(this.querySelector('.search-query'), 'keyup', debounce(function() {
            ...
            // Update total
            var totalOutput = numberWithCommas(filteredTotal) + ' <span class="perc">' + (filteredTotal / total * 100).toFixed(2) + '%</span>';
