...
import pairs from 'lodash/objects/pairs';
import $ from 'common/utils/$';
import config from 'common/utils/config';
import template from 'common/utils/template';
import adSlotTpl from 'text!common/views/commercial/ad-slot.html';
...
export default function(name, types, series, keywords, slotTarget) {
    var attrName,
