...
import expandableV2Tpl from 'text!common/views/commercial/creatives/expandable-v2.html';
...
ExpandableV2.prototype.listener = function() {
    if ((window.pageYOffset + bonzo.viewport().height) > (this.$adSlot.offset().top + this.openedHeight)) {
        ...
        storage.local.set('gu.commercial.expandable.' + this.params.ecid, true, {
