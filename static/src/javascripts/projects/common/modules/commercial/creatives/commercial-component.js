...
import size from 'lodash/collections/size';
...
var constructQuery = function(params) {
    ...
    CommercialComponent = function($adSlot, params) {
        ...
        this.components = {
            ...
            book: buildComponentUrl('books/book', merge({}, this.params, {
                t: config.page.isbn || this.params.isbn
            })),
            books: buildComponentUrl('books/books', merge({}, this.params, {
                t: this.params.isbns ? this.params.isbns.split(',') : []
            })),
            jobs: buildComponentUrl('jobs', merge({}, this.params, {
                t: this.params.jobIds ? this.params.jobIds.split(',') : []
            })),
            masterclasses: buildComponentUrl('masterclasses', merge({}, this.params, {
                t: this.params.ids ? this.params.ids.split(',') : []
            })),
