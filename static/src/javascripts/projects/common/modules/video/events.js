...
import OmnitureMedia from 'common/modules/analytics/omnitureMedia';
import history from 'common/modules/onward/history';
import adsSkipOverlayTmpl from 'text!common/views/ui/video-ads-skip-overlay.html';
var isDesktop = detect.isBreakpoint({
        min: 'desktop'
    }),
